    ...
    return (
        ...
        >
            ...
            <div className="absolute w-[72.22vw] top-3  left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col justify-between items-center z-10  ">
                <h1 className="text-[40px] font-semibold ">Help Is One Click Away</h1>
                ...
                <div className="flex gap-[0.83vw]">
                    {socials.map((social) => (
                        <a
                            ...
                            className="w-[2.78vw] h-[2.78vw] max-w-[32px] max-h-[32px] p-[min(0.75vw,8px)] rounded-full border border-white/20 flex items-center justify-center bg-[#3e65a5] hover:bg-white/10 text-white hover:border-white transition-all cursor-pointer"
                        >
            ...
            {/* //section 3 */}
            <div className=" w-full flex justify-center items-center py-[20px] border-t-[1px] border-[#ffffff50]">
